...
void autoGenNormal() {
	...
	vec4 sample1 = texture(frxs_baseColor, frx_mapNormalizedUV(repeatAndMirrorCoords(uv1)));
	vec4 sample2 = texture(frxs_baseColor, frx_mapNormalizedUV(repeatAndMirrorCoords(uv2)));
	vec4 sample3 = texture(frxs_baseColor, frx_mapNormalizedUV(repeatAndMirrorCoords(uv3)));
	vec4 sample4 = texture(frxs_baseColor, frx_mapNormalizedUV(repeatAndMirrorCoords(uv4)));
