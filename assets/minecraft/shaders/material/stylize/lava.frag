...
void frx_materialFragment() {
        ...
        mix(vec2(0.5), (abs(frx_vertexNormal.y - 1.0) > 0.01 ? (-normalize(frx_vertexNormal.xz) + mix(vec2(0.0, 0.5), vec2(0.0, 1.0), 1.0 - abs(frx_vertexNormal.y))) : vec2(0.0)), 1.0 - frx_worldIsOverworld);
